...
public class ServerShellClientMain2
{
    private static Log log = LogFactory.getLog(ServerShellClientMain2.class);

    public static void main(String[] args) throws Exception
    {
    	new ServerShellClientMain2();
       
    }

    public ServerShellClientMain2() throws Exception
    {
//        log.info("Loading properties");
    	System.out.println("Loading properties");
        Properties properties = new Properties();
        InputStream propertiesIS = ServerShellClientMain2.class.getClassLoader().getResourceAsStream(ServerShellConstants.CONFIG_FILENAME);
...
//        log.info("Attach to server via JMX");
        ...
        proxy.createEPL("select * from SensorEvent(value>30)","filterStatem", new ClientSideUpdateListener());
