...
//        log.info("Via Java Management JMX proxy: Creating statement '" + expression + "' named '" + statementName + "'");
    	System.out.println("Via Java Management JMX proxy: Creating statement '" + expression + "' named '" + statementName + "'");
...
//        log.info("Via Java Management JMX proxy: Destroying statement '" + statementName + "'");
        System.out.println("Via Java Management JMX proxy: Destroying statement '" + statementName + "'");
